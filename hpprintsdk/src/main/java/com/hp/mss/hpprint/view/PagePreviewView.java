...
import com.example.hpprintsdk.R;
...
public class PagePreviewView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.saveLayer(pageBounds.left, pageBounds.top, pageBounds.right, pageBounds.bottom, null, Canvas.ALL_SAVE_FLAG /*Canvas.CLIP_TO_LAYER_SAVE_FLAG | Canvas.MATRIX_SAVE_FLAG*/);
